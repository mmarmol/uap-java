...
public class ParserTest {
	...
	public void testParseAll() {
		...
		Client expected1 = new Client(agentString1,new Browser("Firefox", "3", "5", "5"),
				new OS("Mac OS X", "10", "4", null, null), new Device("Other", null, null));
		Client expected2 = new Client(agentString2,new Browser("Mobile Safari", "5", "1", null),
	...
	public void testReplacementQuoting() throws Exception {
		...
		assertThat(result.browser.family, is("ABC (12\\34)"));
	...
	void testUserAgentFromYaml(String url) {
		...
		for (Map<String, String> testCase : testCases) {
			...
			assertThat(uaString, parser.parseBrowser(uaString), is(Browser.fromMap(testCase)));
		}
	}
